pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/khanalb'                                                                    //<------your MiamiID
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/khanalb58/225-lab3-7.git'                                    //<------your MiamiID
        KUBECONFIG = credentials('khanalb-225')                                                         //<------your MiamiID
    }
        ...
        stage ("Run Security Checks") {
            steps {
                ...
                sh '''
                    ...
                    -e BURP_START_URL=http://10.48.229.187 \
